...
@SpringJUnitConfig(classes = {HearingInterpretorTestComponentScan.TestConfig.class})
class HearingInterpretorTestComponentScan {
  ...
  @Test
  void whatIHeard() {
    System.out.println(interpretor.getWordProducer());
